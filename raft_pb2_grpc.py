...
class RaftNodeStub:
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                ...
                request_serializer=raft__pb2.MsgVoteRequest.SerializeToString,
                response_deserializer=raft__pb2.MsgVoteResponse.FromString,
...
def add_RaftNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RequestVote': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.MsgVoteRequest.FromString,
                    response_serializer=raft__pb2.MsgVoteResponse.SerializeToString,
            ),
...
class RaftNode:
    ...
    def RequestVote(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/RaftNode/RequestVote',
            raft__pb2.MsgVoteRequest.SerializeToString,
            raft__pb2.MsgVoteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
